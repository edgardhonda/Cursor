...
class MainActivity : FlutterActivity() {
    ...
    private fun initSounds() {
        ...
        stepId = pool.load(this, R.raw.step, 1)
        bumpId = pool.load(this, R.raw.bump, 1)
        victoryId = pool.load(this, R.raw.victory, 1)
    ...
    companion object {
        private const val SYSTEM_UI_CHANNEL = "com.edgard.mapa/system_ui"
        private const val AUDIO_CHANNEL = "com.edgard.mapa/audio"
    }
}
