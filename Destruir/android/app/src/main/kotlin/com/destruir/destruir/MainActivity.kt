...
class MainActivity : FlutterActivity() {
    private val channelName = "com.destruir.destruir/system_ui"
    private val audioChannelName = "com.destruir.destruir/audio"
    ...
    private fun initSounds() {
        ...
        dragId = pool.load(this, R.raw.drag, 1)
        destroyId = pool.load(this, R.raw.destroy, 1)
        soundPool = pool
    }
