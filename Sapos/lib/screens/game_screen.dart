...
class _GameScreenState extends State<GameScreen>
  ...
  static const _systemUiChannel = MethodChannel('com.edgard.sapos/system_ui');
            ...
            children: [
                ...
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    return Listener(
                      ...
                      onPointerDown: (event) {
                        _engine.pointerDown(event.pointer, event.localPosition);
                      },
                      onPointerMove: (event) {
                        _engine.pointerMove(event.pointer, event.localPosition);
                      },
                      onPointerUp: (event) {
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  ...
                  border: Border(
                    top: BorderSide(color: Color(0xFFA5D6A7), width: 1),
                  ),
                ),
                child: Row(
                  children: [
