...
class MainActivity : FlutterActivity() {
    ...
    private fun initializeSounds() {
        ...
        soundPool = SoundPool.Builder()
            ...
            .build()
        soundIds["construction"] = soundPool.load(this, R.raw.construction, 1)
        soundIds["explosion"] = soundPool.load(this, R.raw.explosion, 1)
        soundIds["fire"] = soundPool.load(this, R.raw.fire, 1)
        soundIds["collapse"] = soundPool.load(this, R.raw.collapse, 1)
    }
    ...
    companion object {
        private const val CHANNEL_NAME = "com.edgard.bombas/system_ui"
        private const val AUDIO_CHANNEL_NAME = "com.edgard.bombas/game_audio"
    }
}
